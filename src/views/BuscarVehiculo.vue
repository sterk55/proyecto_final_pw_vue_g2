      ...
      <div v-if="mostrar">
        <table id="table" class="table">
          ...
          <tr v-for="auto in lista" v-bind:key="auto">
            ...
            <td><router-link :to="{path:'/buscar/vehiculo', params:{idCliente: auto.id}}"> Visualizar</router-link></td>
            <td><router-link :to="{path:'/empleados/actualizar/vehiculo', params:{idV: auto.id}}"> Actualizar</router-link></td>
            <td><button v-on:click="eliminar(1)">Eliminar</button></td>
          </tr>
          </tbody>
        </table>
      </div>
...
import {obtenerVehiculos} from "@/helpers/cliente";
import {borrarVehiculoPorIdFachada} from "../helpers/empleado";
...
export default {
  ...
  methods: {
    ...
    async eliminar(id) {
      await borrarVehiculoPorIdFachada(id)
    },
    async consultar() {
